...
if (request.getParameter("session")!=null && request.getParameter("session").equals("0")) {
      ...
      out.write("                <p class=\"text\">По всем вопросам обращайтесь по адресу <a href=\"mailto:bonertalexandr@gmail.com\">bonertalexandr@gmail.com</a></p>\n");
      out.write("                <p>&nbsp;</p>\n");
      out.write("\n");
      out.write("            </div>\n");
      out.write("\n");
      ...
      out.write("                Разработчик: Александр Бонерт, 2016 г\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
